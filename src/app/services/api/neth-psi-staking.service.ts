...
export class NethPsiStakingService {
  ...
  query(msg: QueryMsg): Promise<any> {
    return this.wasm.query(this.terrajs.settings.nEthPsiStaking, msg);
  }

  handle(msg: ExecuteMsg, opts?: ExecuteOptions) {
    return this.wasm.execute(this.terrajs.settings.nEthPsiStaking, msg, opts);
  }
}
