...
import { ConfigInfo } from './astroport_token_token_farm/config_info';
import { ExecuteMsg } from './astroport_token_token_farm/execute_msg';
import { PoolsResponse } from './astroport_token_token_farm/pools_response';
import { QueryMsg } from './astroport_token_token_farm/query_msg';
import { RewardInfoResponse } from './astroport_token_token_farm/reward_info_response';
import { StateInfo } from './astroport_token_token_farm/state_info';
import { WasmService } from './wasm.service';

@Injectable({
  providedIn: 'root'
})
export class AstroportTokenTokenFarmService {
