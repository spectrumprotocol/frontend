...
export class StakerAstroportService {
  ...
  query(msg: QueryMsg): Promise<any> {
    return this.wasm.query(this.terrajs.settings.stakerAstroport, msg);
  }

  handle(msg: ExecuteMsg, opts?: ExecuteOptions) {
    return this.wasm.execute(this.terrajs.settings.stakerAstroport, msg, opts);
  }
}
