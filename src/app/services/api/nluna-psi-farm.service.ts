...
export class NlunaPsiFarmService {
  ...
  query(msg: QueryMsg): Promise<any> {
    return this.wasm.query(this.terrajs.settings.nLunaPsiFarm, msg);
  }

  handle(msg: ExecuteMsg, opts?: ExecuteOptions) {
    return this.wasm.execute(this.terrajs.settings.nLunaPsiFarm, msg, opts);
  }
}
