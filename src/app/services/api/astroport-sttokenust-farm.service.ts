...
import {ConfigInfo} from './astroport_sttoken_ust_farm/config_info';
import {ExecuteMsg} from './astroport_sttoken_ust_farm/execute_msg';
import {PoolsResponse} from './astroport_sttoken_ust_farm/pools_response';
import {QueryMsg} from './astroport_sttoken_ust_farm/query_msg';
import {RewardInfoResponse} from './astroport_sttoken_ust_farm/reward_info_response';
import {StateInfo} from './astroport_sttoken_ust_farm/state_info';
import {WasmService} from './wasm.service';

@Injectable({
  providedIn: 'root'
})
export class AstroportSttokenUstFarmService {
