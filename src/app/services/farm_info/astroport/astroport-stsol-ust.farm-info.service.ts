...
@Injectable()
export class AstroportStsolUstFarmInfoService implements FarmInfoService {
  farm = 'Lido';
  autoCompound = true;
  autoStake = false;
  farmColor = '#e59283';
  ...
  get defaultBaseTokenContract() {
    return this.terrajs.settings.stsolToken;
  }

  get farmContract() {
    return this.terrajs.settings.astroportStsolUstFarm;
  }
