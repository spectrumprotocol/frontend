...
@Injectable()
export class AstroportXdefiUstFarmInfoService implements FarmInfoService {
  farm = 'XDEFI';
  autoCompound = true;
  autoStake = false;
  farmColor = '#112268';
  ...
  get defaultBaseTokenContract() {
    return this.terrajs.settings.xdefiToken;
  }
  ...
  get farmContract() {
    return this.terrajs.settings.astroportXdefiUstFarm;
  }
